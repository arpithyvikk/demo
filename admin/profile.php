                    ...
                    <div class="well profile">
                        <div class="col-sm-12">
                            <div class="col-xs-12 col-sm-12 col-md-8 offset-md-2">
                                ...
                                <br>
                                <a href="update.php?id=<?php echo $id; ?>"><button class="btn btn-primary" type="button">Edit User</button></a>
                                <a href="delete.php?id=<?php echo $id; ?>" onclick="return confirm('Are you sure you want to delete this user?');"><button class="btn btn-danger" type="button">Remove User</button></a>
                            </div>             
                        </div>            
                    </div>
                </div>
